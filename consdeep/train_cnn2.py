...
def main():
    ...
    nb_filter1 = int(sys.argv[3])
    nb_filter2 = int(sys.argv[4])
    nb_hidden = int(sys.argv[5])
    dropout_cnn = float(sys.argv[6])
    dropout_mlp = float(sys.argv[7])
    filter_len1 = int(sys.argv[8])
    filter_len2 = int(sys.argv[9])
